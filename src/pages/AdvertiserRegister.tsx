    ...
    <div className="min-h-screen lg:h-screen w-full grid lg:grid-cols-2 text-slate-800 font-sans selection:bg-blue-500/20 bg-white overflow-x-hidden relative">
      ...
      <div className="flex items-center justify-center p-4 sm:p-12 relative overflow-y-auto overflow-x-hidden bg-white h-full w-full">
        <div className="w-full max-w-md space-y-6 animate-in fade-in duration-500 relative z-10 py-6">
          {isRegistered ? (
            <div className="text-center space-y-6 py-8 animate-in fade-in zoom-in duration-300 font-sans text-slate-800 text-left">
              <div className="h-16 w-16 bg-amber-50 rounded-2xl flex items-center justify-center text-amber-500 mx-auto border border-amber-100 shadow-sm">
                <CheckCircle2 className="h-8 w-8 animate-pulse" />
              </div>
              
              <div className="space-y-3 text-center">
                <h1 className="text-2xl font-extrabold text-slate-900 leading-tight">Application Submitted</h1>
                <p className="text-sm text-slate-600 leading-relaxed font-semibold">
                  Your account is pending. Please allow 24-48 hours for our team to review the application.
                </p>
                <p className="text-xs text-slate-400 font-medium">
                  An administrator will manually verify your company and website details. You will receive an email notification once your advertiser account is activated.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  ...
                  className="bg-[#0052FF] hover:bg-blue-700 text-white font-bold px-6 h-12 rounded-xl transition-all cursor-pointer text-xs flex items-center justify-center shadow-md shadow-blue-500/10"
                >
                  Proceed to Portal
                </button>
                <a
                  href={getLandingUrl('/')}
                  className="bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-655 font-bold px-6 h-12 rounded-xl transition-all cursor-pointer text-xs flex items-center justify-center"
                >
                  Return to Home
                </a>
              </div>
